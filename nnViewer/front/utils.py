...
# def get_node_info2(node):
#     if isinstance(node, Conv2dNode):
#         return {
#             "Input Shape": get_tuple_of_tensors_shapes_as_string(get_var_as_tuple_tensor(node.input)),
#             "Output Shape": get_tuple_of_tensors_shapes_as_string(get_var_as_tuple_tensor(node.output)),
#             "Number of Parameters": "{:,}".format(node.nb_parameters),
#             "Input Chanels": str(node.module.in_channels),
#             "Output Chanels": str(node.module.out_channels),
#             "Kernel Size": f"{str(node.module.kernel_size[0])} x {str(node.module.kernel_size[1])}",
...
#             "Input Chanels": str(node.module.in_channels),
#             "Output Chanels": str(node.module.out_channels),
#             "Kernel Size": f"{str(node.module.kernel_size[0])}",
...
#             "Output Shape": get_tuple_of_tensors_shapes_as_string(get_var_as_tuple_tensor(node.output)),
#             "Number of Parameters": "{:,}".format(node.nb_parameters),
#             "Size of the Dictionary of Embeddings": str(node.module.num_embeddings),
...
#         return {
#             "First Element": format_matrix_data(node.mat1),
#             "Second Element": format_matrix_data(node.mat1),
#         }
#
#
...
#             "Output": format_matrix_data(node.output),
#         }
#
...
#         return {
#             "First Element": format_matrix_data(node.mat1),
#             "Second Element": format_matrix_data(node.mat2),
#         }
#
...
#         return {
#             "Input Tensor Shape": format_matrix_data(node.input),
#             "Pow Value": format_matrix_data(node.pow_value),
#         }
#
#     elif isinstance(node, MeanNode):
#         return {
#             "Input Tensor Shape": format_matrix_data(node.input),
#             "Output Tensor Shape": format_matrix_data(node.output),
...
#         return {
#             "Shape of Tensor to Stack": get_tuple_of_tensors_shapes_as_string(get_var_as_tuple_tensor(node.input)),
#             "Output Tensor Shape":  get_tuple_of_tensors_shapes_as_string(get_var_as_tuple_tensor(node.output)),
#         }
#
...
#         return {
#             "Node Name": node.name,
#             "Variable Shape": get_tuple_of_tensors_shapes_as_string(get_var_as_tuple_tensor(node.variable)),
#         }
#

def get_node_info(node):
    # Fonction helper pour créer un dictionnaire avec des métadonnées sur les tenseurs
